...
func IsCountryCodeAlpha2(val any) bool {
	code, ok := val.(string)
	if !ok {
		return false
	}
	return iso3166_1_alpha2[code]
}

func IsCountryCodeAlpha3(val any) bool {
	code, ok := val.(string)
	if !ok {
		return false
	}
	return iso3166_1_alpha3[code]
}

func IsCountryCodeAlphaNumeric(val any) bool {
	code, ok := val.(int)
	if !ok {
		return false
	}
...
func IsCountryCode(val any) bool {
	code, ok := val.(string)
	if !ok {
		return false
	}
	return iso3166_2[code]
}
